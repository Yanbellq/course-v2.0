...
export const dev = gulp.series(
  clean,
  gulp.parallel(crmStyles, userStyles, tailwind, crmScripts, userScripts, images, fonts),
...
export const build = gulp.series(
  clean,
  gulp.parallel(crmStyles, userStyles, tailwind, crmScripts, userScripts, images, fonts),
  gulp.parallel(minifyCrmStyles, minifyUserStyles, minifyTailwind, minifyCrmScripts, minifyUserScripts)
);
